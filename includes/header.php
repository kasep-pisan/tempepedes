        ...
        <div class="navbar-wrapper">
          ...
          <ul class="navbar-nav">
            ...
            <li>
             ...
             <li>
              <a href="admin/admin-login.php" class="nav-link">Admin login</a>
            </li>
...
function subTotal() {
    ...
    for (var i = 0; i < iprice.length; i++) {
        ...
        itotal[i].innerText = new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR" }).format(total);
        gt += total;
    }

    gtotal.innerText = "Total: " + new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR" }).format(gt);
}
