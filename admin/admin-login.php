    ...
    if ($result) {
        if (mysqli_num_rows($result) == 1) {
            ...
            if (password_verify($_POST['password'], $result_fetch['password'])) {
                $_SESSION['admin_logged_in'] = true; // Membuat session variabel untuk username
        ...
        echo "
        <script>
        alert('MASALAH: permintaan tidak dapat dijalankan!');
        window.location.href='admin-login.php';
        </script>
        ";
    }
...
<body>
    ...
    <div class="container">
            ...
            <nav class="navbar">
                <div class="navbar-wrapper">
                    <a href="#">
                        ...
                        <a href="admin-register.php" class="nav-link">Register Admin</a>
        ...
        <main>
            ...
            <ssection class="contact-section" id="home">
