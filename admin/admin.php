...
<head>
    ...
    <title>Admin pannel - Prigi</title>
</head>
<body>
                ...
                <div aria-label="breadcrumb mb-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb d-flex justify-content-center align-items-center">
                            ...
                            <li class="breadcrumb-item"><a href="../index.php">Prigi</a></li>
                                    ...
                                    if (mysqli_num_rows($usersResult) > 0) {
                                        ...
                                        while ($userRow = mysqli_fetch_assoc($usersResult)) {
                                            echo '<li class="list-group-item d-flex justify-content-between align-items-center">
                                                    ...
                                                    <button type="button" class="btn btn-danger" onclick="confirmDelete(\'' . $userRow['order_id'] . '\')">Delete</button>
                                                </li>';
                                        }
